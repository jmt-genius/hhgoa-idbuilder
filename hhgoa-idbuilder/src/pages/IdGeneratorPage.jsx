...
export default function IdGeneratorPage() {
  ...
  return (
    <div className="min-h-screen font-mono text-[#eaf5ee] bg-[#07130c]" style={{ background: 'radial-gradient(circle at 15% 10%, #0e2618 0%, transparent 45%), radial-gradient(circle at 85% 90%, #10281a 0%, transparent 40%), #07130c' }}>
      <div className="max-w-[1180px] mx-auto px-3.5 sm:px-5 py-5 sm:py-9 pb-20">
        <header className="flex items-baseline justify-between gap-3.5 sm:gap-5 flex-wrap mb-5 sm:mb-7 border-b border-dashed border-[#1e3a28] pb-3.5 sm:pb-[18px]">
          <div>
            <div className="text-[10px] sm:text-xs tracking-[2px] text-[#7fae8d] uppercase">&gt;&gt;&gt; INIT: ID_GENERATOR</div>
            <div className="font-['Space_Grotesk'] font-bold text-[18px] sm:text-[22px] tracking-[0.5px] text-[#f6cf1f]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6 sm:gap-7 items-start">
